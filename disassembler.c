//
// Created by Ed Salisbury on 3/25/20.
//
#include <stdio.h>
#include <stdlib.h>
...
int disassemble(unsigned char *codebuffer, int pc) {
    ...
    switch (*code) {
        ...
        case 0x39:
            ...
            break;
        case 0x3a:
            printf("LDA    $%0x%02x", code[2], code[1]);
            opbytes = 3;
            break;
        case 0x3b:
            printf("DCX   SP");
...
int main(int argc, char **argv) {
    ...
    if (argc < 2) {
        printf("Usage: disassemble <sourcefile>");
        return (1);
    }
    ...
    while (opbytes < filesize) {
        opbytes += disassemble(buffer, opbytes);
    }
